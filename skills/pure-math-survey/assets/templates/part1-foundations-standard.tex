...
\section{Equivalent formulations and their scope}\label{sec:standard-depth}
\placeholder{Choose an equivalent formulation that changes what the reader can compute or prove. Derive the equivalence or identify the exact external result; explain the hypotheses at the point of use. Extend the completed model only when the extension reveals a new mechanism. Give a genuine failure at the boundary rather than a second decorative example.}
