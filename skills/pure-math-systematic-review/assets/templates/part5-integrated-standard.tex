...
\end{theorem}
\placeholder{Deepen the interpretation of Theorem~\ref{thm:principal}: compare its force with neighboring answers and explain the role of significant conditions. Add a useful variant only after clarifying the common core; a different claim needs a separately justified statement.}
